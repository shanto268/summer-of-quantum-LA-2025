      ...
      <main className="min-h-screen bg-gradient-to-br from-la-sky via-la-blush to-la-sand text-gray-900 pt-20">
        ...
        <section className="py-12 sm:py-20 px-4 relative overflow-hidden bg-white">
          ...
          <div className="container mx-auto">
            <SectionHeading
              title={locale === 'es' ? 'Nuestros increíbles voluntarios' : 'Our Amazing Volunteers'}
              subtitle={locale === 'es' ? 'Conoce al equipo dedicado a hacer que la ciencia cuántica sea accesible en Los Ángeles' : 'Meet the dedicated team making quantum science accessible across Los Angeles'}
            />
            ...
            <div className="mt-12 bg-gradient-to-r from-la-sky to-la-blush p-5 sm:p-8 rounded-2xl border border-la-sunset/20 shadow-md shadow-la-sand/40">
                ...
                {locale === 'es' ? '¡Únete a nuestro equipo de voluntarios!' : 'Join Our Volunteer Team!'}
                </h3>
              <p className="text-sm sm:text-base text-gray-700 mb-4 sm:mb-6">
            
                 {locale === 'es'
                  ? 'Siempre estamos buscando voluntarios entusiastas para ayudar a hacer que la ciencia cuántica sea accesible para todos en Los Ángeles. Ya seas científico, educador, estudiante o simplemente te apasione la comunicación científica, ¡nos encantaría que te unas a nuestro equipo!'
                  : "We're always looking for enthusiastic volunteers to help make quantum science accessible to everyone in LA. Whether you're a scientist, educator, student, or simply passionate about science communication, we'd love to have you join our team!"
                }
              ...
              <div className="flex flex-wrap gap-3 sm:gap-4">
                ...
                >
                  {locale === 'es' ? 'Solicita ser voluntario' : 'Apply to Volunteer'}
                </a>
                <a
                  href="/#event-overview"
                ...
                >
                  {locale === 'es' ? 'Conoce más sobre nuestros eventos' : 'Learn More About Our Events'}
                </a>
              </div>
            </div>
          </div>
